					...
					<form name="myform" id="myform" action="<?php echo U('adminrole/editadmingroup',array('role_id'=>$groupinfo['role_id']));?>" method="post">
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input name="info[role_name]" id="role_name" type="text" class="dfinput" value="<?php echo ($groupinfo["role_name"]); ?>" datatype="/^[\u4E00-\u9FA5\uf900-\ufa2d]{2,10}$/" errormsg="角色名范围在2~10位之间，汉字！" maxlength="10" readonly />
