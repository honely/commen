...
<html>
	...
	<body>
		<div class="right_min">
			...
			<div class="min">
				<div class="form_box">
					<form name="myform" id="myform" action="<?php echo U('admininfo/addadmin');?>" method="post">
						<div class="form-item">
							<label class="form-label">用户名</label>
							<div class="form-text form-input-block">
								<input name="info[username]" id="username" type="text" class="dfinput" ajaxurl="<?php echo U('admininfo/existadmin');?>" datatype="*4-20" errormsg="用户名范围在4~20位之间！" maxlength="20" />
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input name="info[password]" id="password" type="password" class="dfinput" datatype="*5-15" nullmsg="请输入密码！" errormsg="密码范围在5~15位之间！" maxlength="20" /><i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
							<label class="form-label">确认密码</label>
							<div class="form-text form-input-block">
								<input name="password2" id="password2" type="password" class="dfinput" datatype="*" recheck="info[password]" nullmsg="请再输入一次密码！" errormsg="您两次输入的密码不一致！" maxlength="20" /><i class="Validform_checktip"></i>
							</div>
						</div>
						...
						<div class="form-item">
							...
							<div class="form-select form-input-block">
								<select id="adminrole" name="info[adminrole]" datatype="*" errormsg="角色不能为空！">
									...
									<?php if(is_array($groupinfo)): $i = 0; $__LIST__ = $groupinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="<?php echo ($data["role_id"]); ?>"><?php echo ($data["role_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
								<i class="Validform_checktip"></i>
							</div>
						</div>
						...
						<div class="form-item">
							...
							<div class="form-radio form-input-block">
								<div class="skin-section">
									<ul>
										<li>
											<input type="radio" name="info[isable]" value="1">
											<span>启用</span>
										</li>
										<li>
											<input type="radio" name="info[isable]" value="2">
											<span>禁用</span>
										</li>
