				...
				<div class="form_box">
					<form name="myform" id="myform" action="<?php echo U('adminmenu/addmenuinfo');?>" method="post">
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input type="text" name="menu_father_title" id="menu_father_title" type="text" class="dfinput" datatype="s2-30" errormsg="菜单父节点范围在2~30位之间！" maxlength="15" value="<?php echo ($father_menuinfo["menu_name"]); ?>" readonly  />
								<i class="Validform_checktip"></i>
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input name="info[sort]" id="sort" type="text" class="dfinput" datatype="/^[1-9]\d*|0$/" errormsg="排序范围在1~5位之间！" maxlength="5" value="0" /><i class="Validform_checktip"></i>
							</div>
						</div>
